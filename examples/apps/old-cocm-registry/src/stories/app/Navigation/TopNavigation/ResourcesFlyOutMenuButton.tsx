...
const solutions = [
    { name: 'Events', description: 'Get a better understanding of your traffic', href: '#', icon: ChartPieIcon },
    {
    ...
    { name: 'Developers', description: 'Build strategic funnels that will convert', href: '#', icon: ArrowPathIcon },
    { name: 'Community', description: "Your customers' data will be safe and secure", href: '#', icon: FingerPrintIcon },
    {
        name: 'Partners',
...
const ResourcesFlyOutMenuButton:React.FC<TopNavFlyOutMenuButtonProps> = ({name}) => {
    return (
...
export default ResourcesFlyOutMenuButton