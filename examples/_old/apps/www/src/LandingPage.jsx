                        ...
                        <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
                            ...
                            <div className="mt-24 sm:mt-32 lg:mt-16">
                                <a href="#" className="inline-flex space-x-6">
                                  <span className="rounded-full px-3 py-1 text-sm font-semibold leading-6 text-black/50 ring-1 ring-inset ring-indigo-500/20">
                                    Latest updates
                                  </span>
                            ...
                            <h1 className="mt-10 text-4xl font-bold tracking-tight text-black sm:text-6xl">
                                The Complete Platform for Integrated Care
                            </h1>
                            <p className="mt-6 text-lg leading-8 text-gray-700">
                                With population health & AI, primary care can now save big, generate more revenue through integrated care models
                            ...
                            <div className="mt-10 flex items-center gap-x-6">
                                <a
                                    href="#"
                                    className="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-black shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400"
                                >
                                    Get started
                                </a>
