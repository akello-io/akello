...
datamodel-codegen --input ../server/data/fhir.schema.json --input-file-type jsonschema --output model.py --output-model-type dataclasses.dataclass --special-field-name-prefix '' --base-class xfhir.hl7.XFHIR
