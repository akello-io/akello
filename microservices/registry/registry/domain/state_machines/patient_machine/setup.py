...
from registry.domain.state_machines.patient_machine.machine import RegistryPatientStateMachine
from registry.domain.state_machines.patient_machine.utils import build_state
